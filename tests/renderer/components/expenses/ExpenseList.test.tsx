...
const EXPENSE_ITEMS = [
  {
    ...
    verification_number: 1, verification_series: 'B',
    expense_type: 'normal', has_credit_note: 0,
  },
  {
    ...
    verification_number: 2, verification_series: 'B',
    expense_type: 'normal', has_credit_note: 0,
  },
  {
...
describe('ExpenseList', () => {
  ...
  it('empty state when no expenses', async () => {
    mockIpcResponse('expense:list', {
      success: true,
      data: { expenses: [], counts: { total: 0, draft: 0, unpaid: 0, partial: 0, paid: 0, overdue: 0 } },
    })
