  ...
  return (
    <aside className="flex h-full w-[220px] flex-col border-r bg-muted/30">
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-3">
        ...
        <SidebarLink to="/overview" icon={LayoutDashboard} label="Översikt" testId="nav-overview" />
        ...
        <SidebarLink to="/customers" icon={Users} label="Kunder" testId="nav-customers" />
        <SidebarLink to="/suppliers" icon={Truck} label="Leverantörer" testId="nav-suppliers" />
        <SidebarLink to="/products" icon={Package} label="Artiklar & Priser" testId="nav-products" />

        <div className="mb-1 mt-4 px-3 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
          Stamdata
        </div>
        <SidebarLink to="/accounts" icon={BookOpen} label="Kontoplan" testId="nav-accounts" />
      ...
      <div className="border-t px-2 py-2">
        <SidebarLink to="/settings" icon={Settings} label="Inställningar" testId="nav-settings" />
      </div>
    </aside>
  )
}
