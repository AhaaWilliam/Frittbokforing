  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          className="fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg border bg-[var(--surface-elevated)] p-6 shadow-xl focus:outline-none"
